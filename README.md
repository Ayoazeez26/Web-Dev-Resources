...
#####  complete all 6 challenges tagged with beginner and submit your repository link (github repo link) and the live project link (hosted link)
...
#####  https://dev.to/arikaturika/javascript-local-storage-beginner-s-guide-1gk1 (Local Storage)
...
### https://devchallenges.io/paths/responsive-web-developer
#####  complete the last 2 challenges and submit your repository link (github repo link) and the live project link (hosted link)
#####  https://www.frontendmentor.io/challenges
#####  visit the web address above and sign up the pick 3 challenges tagged with JUNIOR(2)  and complete them then submit your repository link (github repo link) and the live project link (hosted link)


##  WEB SECURITY

#####  https://developer.mozilla.org/en-US/docs/Web/HTTP/CORS (CORS)
#####  https://www.synopsys.com/glossary/what-is-owasp-top-10.html (OWASP)
#####  https://www.cloudflare.com/learning/security/threats/owasp-top-10/ (OWASP)
#####  https://www.freecodecamp.org/news/web-security-an-introduction-to-http-5fa07140f9b3/ (HTTP)
#####  https://developer.mozilla.org/en-US/docs/Web/Security (Web Security)
#####  https://blog.sqreen.com/what-is-a-csp/ (Content Security Policy)


## PACKAGE MANAGERS

#####  https://nodesource.com/blog/an-absolute-beginners-guide-to-using-npm/ (NPM)
#####  https://classic.yarnpkg.com/en/docs/getting-started/ (YARN)


##  CSS PREPROCESSORS

#####  https://www.youtube.com/watch?v=nu5mdN2JIwM (SASS)
...
#####  Pick from any of your previous projects and use any of the css preprocessors you've learnt above on the project


##  BUILD TOOLS

#####  https://eslint.org/docs/user-guide/getting-started (ESLINT)
#####  https://webpack.js.org/guides/getting-started/ (WEBPACK)


##  CSS FRAMEWORKS

#####  https://getbootstrap.com/docs/5.0/getting-started/introduction/ (Bootstrap)
#####  https://www.youtube.com/watch?v=c9B4TPnak1A (Bootstrap)
#####  https://tailwindcss.com/docs (Tailwind)
#####  https://www.youtube.com/watch?v=j_5-LISy9Qg (Tailwind)



## PRACTICE EXERCISES !!!

#####  Pick from any of your previous projects and use any of the css frameworks you've learnt above on the project
